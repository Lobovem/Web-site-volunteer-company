    ...
    <div className={s.socialLine}>
      <div className={s.socialLine__wrap}>
        ...
        <div className={s.socialLine__socialWrap}>
          ...
          >
            <img src="./img/facebook.svg" alt="facebook.svg" />
          </a>
          <a className={s.socialLine__link} target="blank" href="https://www.instagram.com/ukrhumbat/?igshid=YmMyMTA2M2Y=">
