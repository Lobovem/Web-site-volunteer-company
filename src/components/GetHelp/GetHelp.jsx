    ...
    <div className={s.getHelp}>
      <div className={s.getHelp__contentWrap}>
        ...
        <div className={s.getHelp__textWrap}>
          <TitleMain title="Кому допомогає міжнародний благодійний фонд “Український гуманітарний батальйон”"></TitleMain>
          ...
          <ul className={s.getHelp__descList}>
            <li className={s.getHelp__desc}>Медицини та здоров'я - медикаменти та все, що пов'язано зі здоров'ям та рятуванням наших захисників;</li>
          ...
          <p className={s.getHelp__desc}>
            Для того щоб записатись на отримання допомоги, та не вистоювати у чергах, потрібно заповнити реєстраційну форму. Вона автоматично реєструє заявку,
            та надсилає вам на пошту підтвердження реєстрації.{' '}
          </p>
        </div>
      </div>
    </div>
